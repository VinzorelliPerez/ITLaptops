namespace ITLaptops
{
	partial class formBrokenLaptops
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			panel1.Controls.Add(TotalCountBroken);
			...
			TotalCountBroken.Location = new Point(65, 51);
			...
			Name = "formBrokenLaptops";
			Text = "formBrokenLaptops";
			Load += formBrokenLaptops_Load;
